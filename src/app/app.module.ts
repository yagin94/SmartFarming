...
export function getAuthServiceConfigs() {
  let configs = new SocialServiceConfig()
    ...
    .addGoogle('37814627490-4dfosa0br2g50n2k99j3t8scurb7303u.apps.googleusercontent.com'); // production
  return configs;
}
...
const config = new AuthServiceConfig([
  {
    ...
    provider: new GoogleLoginProvider('37814627490-4dfosa0br2g50n2k99j3t8scurb7303u.apps.googleusercontent.com') // production
  },
  {
